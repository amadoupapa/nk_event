				...
				<div class="container-fluid">
					...
					<div class="container-fluid">
						...
						<div
							...
							<h1 class="h3 mb-0 text-gray-800">Detail de l'évenement</h1>
						</div>
						<!-- ------------DEBUT DETAIL------------------>
						<div class="row">
							<div class="col-md-4">
							...
							<div class="col-md-8">
								<div class="card">
									<div class="card-body">
										<h2 class="card-title">
											Nom de l'événement : <span class="text-muted">${nom}</span>
										</h2>
										<p class="card-text">
										...
										<p class="card-text">
											Statut : <span class="text-muted">${estTermine ? "Terminé" : "En cours"}</span>
										</p>
										<p class="card-text">
											Nombre de places disponibles : <span class="text-muted">${nbPlaceDisponible}</span>
										</p>
										<p class="card-text">
											Capacité maximale : <span class="text-muted">${capaciteMax}</span>
										</p>
									</div>
								</div>
							</div>
